function rate_matrixGFP = GFP_production_rate_per_cell(time, GFP_per_cell_values, timestep, x1, x2, index, timestep_min)
    
    rate_matrixGFP = zeros(length(time), 12);
